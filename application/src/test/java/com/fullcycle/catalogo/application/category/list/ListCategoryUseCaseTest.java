...
public class ListCategoryUseCaseTest extends UseCaseTest {
    ...
    public void givenValidQuery_whenCallsListCategories_shouldReturnCategories() {
        ...
        when(categoryGateway.findAll(any())).thenReturn(pagination);
        ...
        assertTrue(expectedItems.size() == actualOutput.data().size() && expectedItems.containsAll(actualOutput.data()));
    }
}
